module.exports = async (client) => {
  ...
  const activities = [
    { name: 'Yû love you 🥰', type: 'WATCHING', status: 'dnd' }, 
    { name: 'y!help 💫', type: 'WATCHING', status: 'dnd' },
    { name: '5 Shards', type: 'WATCHING', status: 'dnd' }
  ];
  ...
  setInterval(() => {
    activities[2] = { name: `${client.guilds.cache.size} Serveurs`, type: 'WATCHING', status: 'dnd' }; // Update server count
